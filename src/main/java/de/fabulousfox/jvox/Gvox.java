...
import de.fabulousfox.jvox.consumerapi.GvoxAdapter;
...
import de.fabulousfox.jvox.consumerapi.config.input.GvoxByteBufferInputAdapterConfig;
import de.fabulousfox.jvox.consumerapi.config.input.GvoxFileInputAdapterConfig;
import de.fabulousfox.jvox.consumerapi.config.output.GvoxFileOutputAdapterConfig;
import de.fabulousfox.jvox.consumerapi.config.parse.GvoxVoxlapParseAdapterConfig;
...
import de.fabulousfox.jvox.enums.GvoxResult;
import de.fabulousfox.jvox.errors.GvoxAdapterContextNullException;
import de.fabulousfox.jvox.errors.GvoxAdapterNullException;
import de.fabulousfox.jvox.errors.GvoxContextNullException;
import de.fabulousfox.jvox.errors.GvoxNotInitializedException;
import de.fabulousfox.jvox.jextract.RuntimeHelper;
import de.fabulousfox.jvox.jextract.gvox_h;
...
public class Gvox {
    ...
    public static GvoxContext create_context(){
        if(!initialized) throw new GvoxNotInitializedException();
    ...
    public static GvoxAdapterContext create_adapter_context(GvoxContext context, GvoxAdapter adapter, GvoxBaseAdapterInfo config){
        ...
        if(configMem == null) configMem = /*nullptr*/ RuntimeHelper.arena.allocate(ADDRESS, MemorySegment.ofAddress(MemorySegment.NULL.address()));
